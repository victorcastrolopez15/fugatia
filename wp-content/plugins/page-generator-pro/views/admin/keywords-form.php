<div class="wrap">
    <h1 class="wp-heading-inline">
        ...
        <span>
        	<?php _e( 'Add New Keyword', 'page-generator-pro' ); ?>
        </span>
    </h1>
	    ...
	    <div id="poststuff">
	    	<div id="post-body" class="metabox-holder columns-1">
	    		...
	    		<div id="post-body-content">
	    			<!-- Form Start -->
	    			<form class="<?php echo $this->base->plugin->name; ?>" name="post" method="post" action="admin.php?page=page-generator-pro-keywords&amp;cmd=form" enctype="multipart/form-data">		
			                    ...
			                    <div class="wpzinc-option">
			                    	...
			                    	<div class="right">
			                    		<div class="right">
				                    		...
				                    		<p class="description">
					                    		<?php _e( 'The source of this Keyword\'s Terms.', 'page-generator-pro' ); ?>
					                    	</p>
				                    	</div>
			                    	</div>
			                    </div>
							                    		...
							                    		switch ( $option['type'] ) {
							                    			...
							                    			case 'media_library':
							                    				...
							                    				<div class="wpzinc-media-library-selector"
										                        	data-input-name="<?php echo $source_name; ?>[<?php echo $option_name; ?>]"
												                        ...
												                        if ( $file ) {
											                        		...
											                        		<li class="wpzinc-media-library-attachment">
											                        			<div class="wpzinc-media-library-insert">
											                        				<input type="hidden" name="<?php echo $source_name; ?>[<?php echo $option_name; ?>]" value="<?php echo $value; ?>" />

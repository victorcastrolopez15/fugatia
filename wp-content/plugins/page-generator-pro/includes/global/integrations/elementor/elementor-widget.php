...
class Page_Generator_Pro_Elementor_Widget extends Elementor\Widget_Base {
	...
	protected function render() {
		...
		echo Page_Generator_Pro()->get_class( 'shortcode' )->build_shortcode( // phpcs:ignore
			Page_Generator_Pro()->plugin->name . '-' . str_replace( 'page-generator-pro-elementor-', '', $this->slug ),  // phpcs:ignore
			$this->shortcode['fields'],  // phpcs:ignore
			$this->get_settings_for_display()  // phpcs:ignore
		);

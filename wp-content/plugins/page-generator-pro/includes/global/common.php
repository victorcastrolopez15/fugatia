...
class Page_Generator_Pro_Common {
	...
	public function get_featured_image_sources() {
		...
		$sources = array(
			...
			'creative_commons' => __( 'Creative Commons', 'page-generator-pro' ),
			'pexels'           => __( 'Pexels', 'page-generator-pro' ),
			'pixabay'          => __( 'Pixabay', 'page-generator-pro' ),
			'wikipedia'        => __( 'Wikipedia', 'page-generator-pro' ),
		);
	...
	public function get_locations_output_types() {
		...
		$output_types = array_merge(
			$this->get_locations_output_types_street_names(),
			$this->get_locations_output_types_zipcodes(),
			$this->get_locations_output_types_zipcode_districts(),
			$this->get_locations_output_types_cities(),
			$this->get_locations_output_types_counties(),
			$this->get_locations_output_types_regions()
		);
	 ...
	 * @return  array
	 */
	public function get_locations_output_types_street_names() {
	 ...
	 * @return  array
	 */
	public function get_locations_output_types_zipcodes() {
	 ...
	 * @return  array
	 */
	public function get_locations_output_types_zipcode_districts() {
	 ...
	 * @return  array
	 */
	public function get_locations_output_types_cities() {
	 ...
	 * @return  array
	 */
	public function get_locations_output_types_counties() {
	 ...
	 * @return  array
	 */
	public function get_locations_output_types_regions() {

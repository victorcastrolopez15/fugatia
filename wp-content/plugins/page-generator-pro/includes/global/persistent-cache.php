...
class Page_Generator_Pro_Persistent_Cache {
	 ...
	 * @param   string $key        Key.
	 * @param   mixed  $params     Parameters.
	 * @param   mixed  $value      Value to cache for the given Key and Sub Key combination.
	 */
	public function set( $key, $params, $value ) {
		...
		update_option( $this->base->plugin->name . '-cache', $cache );
	...
	public function delete() {
		...
		delete_option( $this->base->plugin->name . '-cache' );

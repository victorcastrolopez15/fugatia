...
class Page_Generator_Pro_Groups_Terms_UI {
	 ...
	 */
	public function output_add_term_fields( $taxonomy ) { // phpcs:ignore
	...
	public function register_wp_editor_on_taxonomy_description() {
		...
		foreach ( $taxonomies as $taxonomy_name ) {
			add_action( $taxonomy_name . '_add_form_fields', array( $this, 'add_term_wp_editor' ), 10, 2 );
	 ...
	 * @param   string $taxonomy   Taxonomy.
	 */
	public function add_term_wp_editor( $taxonomy ) { // phpcs:ignore
	 ...
	 * @param   string  $taxonomy   Taxonomy.
	 */
	public function edit_term_wp_editor( $term, $taxonomy ) { // phpcs:ignore
	 ...
	 * @param   string  $taxonomy   Taxonomy.
	 */
	public function output_edit_term_start( $term, $taxonomy ) { // phpcs:ignore
	 ...
	 * @param   string  $taxonomy   Taxonomy.
	 */
	public function output_edit_term_fields( $term, $taxonomy ) { // phpcs:ignore
	 ...
	 * @param   string  $taxonomy   Taxonomy.
	 */
	public function output_edit_term_end( $term, $taxonomy ) { // phpcs:ignore
	 ...
	 * @param   string $taxonomy           Taxonomy.
	 */
	public function create_term( $term_id, $taxonomy_term_id, $taxonomy ) { // phpcs:ignore
		...
		$settings = array(
			...
			'parent_term' => sanitize_text_field( $_POST['parent_term'] ),
		);
	 ...
	 * @param   string $taxonomy           Taxonomy.
	 */
	public function edit_term( $term_id, $taxonomy_term_id, $taxonomy ) { // phpcs:ignore

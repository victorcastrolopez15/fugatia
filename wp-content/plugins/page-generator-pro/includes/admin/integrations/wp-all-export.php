...
class Page_Generator_Pro_WP_All_Export extends Page_Generator_Pro_Integration {
	 ...
	 */
	public function enqueue_js( $screen, $post, $minified ) { // phpcs:ignore
		...
		if ( ! isset( $_REQUEST['page-generator-pro-group-id'] ) ) { // phpcs:ignore
			return;
		}

		// Get Group ID.
		$group_id = absint( $_REQUEST['page-generator-pro-group-id'] ); // phpcs:ignore

...
class Page_Generator_Pro_Brizy extends Page_Generator_Pro_Integration {
	...
	public function brizy_decode_meta( $value ) {
		...
		$value['brizy-post']['compiled_html'] = base64_decode( $value['brizy-post']['compiled_html'] ); // phpcs:ignore
		$value['brizy-post']['editor_data']   = base64_decode( $value['brizy-post']['editor_data'] ); // phpcs:ignore
	 ...
	 *
	 * @param   array $value   Brizy Page Builder Data.
	 * @return  string          Brizy Page Builder Data
	 */
	public function brizy_encode_meta( $value ) {
		...
		$value['brizy-post']['compiled_html'] = base64_encode( $value['brizy-post']['compiled_html'] ); // phpcs:ignore
		$value['brizy-post']['editor_data']   = base64_encode( $value['brizy-post']['editor_data'] ); // phpcs:ignore

...
class Page_Generator_Pro_Rank_Math extends Page_Generator_Pro_Integration {
	 ...
	 */
	public function replace_action_metaboxes( $post_type_instance, $is_gutenberg_page ) { // phpcs:ignore
	...
	public function output_meta_box_actions_top( $post ) {
		...
		if ( $this->base->get_class( 'groups' )->generates_content( $group_id ) ) {
			$generate_actions = $this->base->get_class( 'groups' )->get_actions_links( $group_id, 'button button-primary button-large' );
		}

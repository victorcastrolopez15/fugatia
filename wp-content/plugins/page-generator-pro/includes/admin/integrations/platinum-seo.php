...
class Page_Generator_Pro_Platinum_SEO extends Page_Generator_Pro_Integration {
	...
	public function groups_content_get_post_meta( $meta, $id ) {
		...
		if ( empty( $platinum_seo_post_meta ) || ! $platinum_seo_post_meta ) {
			return $meta;
		}
	 ...
	 */
	public function groups_content_set_post_meta( $post_id, $group_id, $post_meta, $settings, $post_args ) { // phpcs:ignore
		...
		if ( empty( $post_meta ) || ! $post_meta || ! count( $post_meta ) ) {
			return;
		}
	...
	public function groups_terms_get_term_meta( $meta, $id ) {
		...
		// Bail if no SEO Metadata.
		if ( empty( $platinum_seo_term_meta ) || ! $platinum_seo_term_meta ) {
			return $meta;
		}

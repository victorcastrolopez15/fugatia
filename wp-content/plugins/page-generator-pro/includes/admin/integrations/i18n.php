...
class Page_Generator_Pro_I18n {
	...
	public function __construct( $base ) {
		...
		// Polylang.
		add_action( 'page_generator_pro_common_get_excluded_taxonomies', array( $this, 'polylang_excluded_taxonomies' ) );
	...
	public function polylang_set_post_language( $post_id, $group_id, $settings, $index ) {
		...
		if ( ! is_array( $languages ) || empty( $languages ) || ! count( $languages ) ) {
			return;
		}
	...
	public function wpml_set_post_language( $post_id, $group_id, $settings, $index ) {
		...
		// Bail if we don't have any Translated Post IDs.

...
class Page_Generator_Pro_OptimizePress extends Page_Generator_Pro_Integration {
	...
	public function should_process_shortcodes_on_post_content( $process, $settings ) {
		...
		if ( $settings['post_meta']['_op3_mode'] != '1' ) { // phpcs:ignore
			return $process;
		}
	 ...
	 * @since   3.4.6
	 *
	 * @param   array $value   Page Builder Data.
	 * @return  string          Page Builder Data
	 */
	public function encode_meta( $value ) {
		...
		return wp_slash( json_encode( $value ) ); // phpcs:ignore
	 ...
	 */
	public function clear_cache( $group_id, $test_mode, $system ) { // phpcs:ignore
